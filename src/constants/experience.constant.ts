export class Experience {
  public static experience = [
    ...
    },
    {
      ...
      products: [
        {
          id: '2cf6b96a-26bb-47aa-b25d-e2f471c06f3e',
          name: 'INTERVIEW IA',
          ...
          techUsed: [
            ...
            { name: 'Node.js', logo: './assets/StackLogo/Node.png' },
            { name: 'PostgreSQL', logo: './assets/StackLogo/Postgres.png' },
            { name: 'Bootstrap', logo: './assets/StackLogo/Bootstrap.png' },
            { name: 'HTML & CSS', logo: './assets/StackLogo/Html.png' },
          ],
        },
        {
          id: '8103883b-60ad-411f-b3f1-059514ac5e59',
          name: 'TRUSTYX',
    ...
    },
    {
      ...
      products: [
        ...
        {
          id: '9b623a5a-7aa9-4768-8233-f81ea539f7a5',
        ...
        {
          id: 'f4e1a816-b9b9-4602-8681-cce094bbc8a8',
        ...
        {
          id: '2362f3fb-e375-4756-9220-aaa845bc2d36',
          name: 'TATA AIA',
