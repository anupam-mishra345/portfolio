...
@Component({
  selector: 'app-techstack-v4',
  templateUrl: './techstack-v4.component.html',
  styleUrls: ['./techstack-v4.component.scss'],
})
export class TechstackV4Component {
  ...
  ngOnInit() {
    ...
    this.dataService.portfolioGeneralGistData.subscribe((value) => {
      this.techstacks = value.techstacks.filter((val: any, ind: any) => true);
